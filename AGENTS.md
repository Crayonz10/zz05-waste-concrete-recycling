...
**权威规则源**: `~/.Codex/agents/language-polisher.md`（Categories A–M，含 Chinglish 消除、时态、修饰语、破折号等 13 类规则）。
...
本项目使用全局 4-Agent Pipeline（`~/.Codex/agents/` + `~/.Codex/commands/`）进行论文撰写和打磨。
