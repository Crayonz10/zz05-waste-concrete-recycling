...
\end{equation}
\begin{equation}
\Pi_R = (\theta k - p_R - m - \mu_R + s)(\alpha p_R - \beta p_M) + (w - m)(\alpha p_M - \beta p_R) - n\frac{c k^2}{2}
\end{equation}
...
\begin{equation}
V_{p_M,p_R}(\{R\}) = \max_{k \in [0,1]} \min_{n \in [0,1]} \{\Pi_R\} = \max_{k \in [0,1]} \min_{n \in [0,1]} \{(\theta k + s - p_R - m - \mu_R)(\alpha p_R - \beta p_M) + (w - m)(\alpha p_M - \beta p_R) - n\frac{ck^2}{2}\}
\end{equation}
...
\begin{equation}
V_{p_M,p_R}(\{R\}) = \max_{k \in [0,1]} \{(\theta k + s - p_R - m - \mu_R)(\alpha p_R - \beta p_M) + (w - m)(\alpha p_M - \beta p_R) - \frac{ck^2}{2}\}
\end{equation}
...
\begin{equation}
V_{p_M,p_R}(\{R\}) = \left(s - p_R - m - \mu_R\right)(\alpha p_R - \beta p_M) + (w - m)(\alpha p_M - \beta p_R) + \frac{\theta^2(\alpha p_R - \beta p_M)^2}{2c}
\end{equation}
...
\begin{equation}
V_{p_M,p_R}(\{M,R\}) = \max_{k \in [0,1]} \{(\theta k + s - p_M - m - \mu_M)(\alpha p_M - \beta p_R) + (\theta k + s - p_R - m - \mu_R)(\alpha p_R - \beta p_M) - \frac{ck^2}{2}\}
\end{equation}
Taking the first derivative of the above equation with respect to $k$ and setting it to zero, we obtain:
\begin{equation}
...
Substituting $k^*$ into the characteristic function, we obtain:
\begin{equation}
V_{p_M,p_R}(\{M,R\}) = (s - p_M - m - \mu_M)(\alpha p_M - \beta p_R) + (s - p_R - m - \mu_R)(\alpha p_R - \beta p_M) + \frac{\theta^2(\alpha - \beta)^2(p_M + p_R)^2}{2c}
\end{equation}
...
\frac{\partial \varphi_R}{\partial p_R} = [\theta^2(\alpha^2 - 3\alpha\beta + \beta^2) + 2c\beta]p_M + [\theta^2(2\alpha^2 - 2\alpha\beta + \beta^2) - 4c\alpha]p_R + 2c[\alpha(s - m - \mu_R) - \beta(w - m)] = 0
\end{cases}
\end{equation}
From this, we can obtain the optimal collection price $p_M^*$ for manufacturer $M$:
\begin{equation}
p_M^* = \frac{
...
\end{equation}
And the optimal collection price $p_R^*$ for recycler $R$:
\begin{equation}
p_R^* = \frac{
\stackrel{}{\begin{aligned}
...
Substituting Equations (27) and (28) into Equation (15), we can obtain the optimal conversion rate:
\begin{equation}
k^* = \frac{
\stackrel{}{\begin{aligned}
