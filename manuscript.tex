...
Rapid development of the construction industry in recent decades has led to a sharp increase in construction and demolition (C\&D) waste generation, with waste concrete accounting for more than half of total C\&D waste \citep{zhao2020Use}. Given the environmental and social damage caused by this waste, urgent management of its recycling is required \citep{wu2019Offsite}. Waste concrete recycling has demonstrated potential to alleviate environmental pressures and shortages of construction raw materials due to its regenerative and utilization value \citep{mostert2021Climate}. Many countries, particularly developed nations with limited natural resources, have widely adopted recycled concrete \cite{yenipazarli2019Incentives}. However, promotion of waste concrete recycling management faces obstacles including immature technologies, unclear economic benefits, and incomplete policies, resulting in low enterprise participation \citep{liu2021Explore,ma2020Challenges}. The waste concrete recycling process involves two major participants: concrete manufacturers and recyclers \cite{he2020Investigation,lu2015Stakeholders}. Confronted with high technical costs and market uncertainties, concrete manufacturers and recyclers often lack the capacity to independently overcome these barriers and require inter-enterprise coordination to achieve complementary advantages, risk sharing, and maximum economic benefits from waste concrete recycling \cite{bao2019Procurement}. Therefore, how to effectively coordinate the waste concrete recycling management process has become a critical management challenge constraining the development of the waste concrete recycling industry.

The waste concrete recycling process generally involves collecting raw waste concrete from the market and the treatment \cite{he2020Investigation}. In this process, concrete manufacturers possess the channel advantage. They can collect waste concrete from construction sites using their delivery trucks on return trips, which keeps their transportation costs relatively low \cite{besklubova2026Establishing}. On the other hand, specialized recyclers use dedicated equipment to process the collected waste into recycled aggregates\cite{chen2025Exploring}. During these interactions, the two prticipants engage in price competition at the front end to secure limited waste concrete resources \cite{he2020Investigation}. At the same time, they can choose to cooperate at the back end by sharing the research and development costs required to improve these processing technologies \cite{liu2019Expand}. These intertwined behaviors form a complex coopetition relationship. However, both parties are often hesitant to actually commit to such cooperation \cite{bao2020Developing}. This is because their competitive and cooperative behaviors mutually influence each other. Pricing battles at the front end directly impact the final profit distribution from technology sharing at the back end, making the ultimate economic benefits of working together unclear \cite{li2020Key}. While previous research has explored recycling strategies, most studies treat collection and processing as separate stages \cite{hu2021Dynamic,yuan2023Differentiated}. They fail to clarify whether these companies should cooperate in such a competitive environment and how they should adjust their prices based on this cooperation. Therefore, it is necessary to explore how the interaction between pricing competition and R\&D investment cooperation affects the decisions and economic benefits for both concrete manufacturers and recyclers.

The environmental impact of the recycling process also complicating the co-opetition dynamics. Although waste concrete recycling offers advantages in conserving virgin resources, the treatment process is often accompanied by substantial carbon emissions \cite{difilippo2019Impacts}. Current mainstream waste concrete recycling technologies primarily rely on crushing, separation, and calcination-based thermal treatment, which still generate considerable carbon dioxide \cite{oh2021Proposal}. To curb industrial carbon emissions, the cap-and-trade mechanism has been widely implemented globally as an effective market-based tool that balances economic benefits with environmental protection \cite{oh2021Proposal,yenipazarli2019Incentives}. Waste concrete recycling is also an industry widely affected by the cap-and-trade mechanism.
For the waste concrete recycling industry, carbon quota constraints and fluctuations in trading prices directly reshape the cost structures and profit margins of participating enterprises, compelling them to consider the economic implications of carbon emissions when making decisions \cite{zheng2025Coopetition}. However, existing research on waste concrete recycling management and economic decision-making has largely overlooked this aspect. The specific impacts of the cap-and-trade mechanism on these co-opetition dynamics remain unclear, resulting in a lack of clarity on how concrete manufactures and recyclers should adjust their decisions under such environmental policy constraints. Therefore, incorporating the cap-and-trade mechanism into the research framework to investigate how it influences the economic benefits of waste concrete recycling and the decision-making behavior of enterprises is necessary.
...
\begin{itemize}
\item \textbf{RQ1:} Considering cap-and-trade mechanism, which decision-making model, non-cooperative game model or biform game model, is more beneficial for concrete manufacturers and recyclers in recycling waste concrete? (Considering cap-and-trade mechanism,should concrete manufacturers and recyclers engage in cooperation within the competitive environment?)
\item \textbf{RQ2:} What are the impacts of the cap-and-trade mechanism on the decisions of concrete manufacturers and recyclers in waste concrete recycling under non-cooperative strategies and co-opetition strategies based on the biform game framework?
\end{itemize}
...
\textbf{The non-cooperative stage}: The manufacturer and recycler determine their pricing strategies non-cooperatively via Nash Equilibrium. Notably, when making pricing decisions in this biform game, both parties anticipate how the final profits will be allocated through the cooperative game based on their technology investment partnership. Therefore, this pricing strategy stage does not yield the final standalone profits but rather establishes the competitive environment.

\textbf{The cooperative stage}: The two parties engage in technology investment cooperation, where the manufacturer helps the recycler share a certain proportion of the technology R\&D costs. They can choose whether to form a cooperative alliance. To determine the profit distribution mechanism, we first calculate the characteristic values of the coalitions. Then, we use the Shapley value to allocate the cooperative surplus based on these characteristic functions. This analysis is conducted under the given competitive environment (i.e., the pricing strategy combination $(p_M, p_R)$) established in the non-cooperative stage. The profits allocated in the cooperative game will be treated as the objective functions for both parties in the non-cooperative stage, and we derive the equilibrium solutions by maximizing these profit functions.
...
Proposition 5(1) indicates that the recycler will inherently achieve a higher technology conversion rate under the biform game framework. In the pure non-cooperative model, the recycler bears the entire R\&D and equipment upgrade cost, leading to insufficient investment incentives due to a high marginal cost burden. The biform game introduces an investment cost-sharing mechanism ($n^{C*}$), which internalizes the positive externalities of technological upgrades. By sharing the upfront costs, the manufacturer directly subsidizes the recycler's R\&D, incentivizing the recycler to extract more value from the waste concrete.
...
Carbon emission quota ($G$) represents the free carbon emission allowance allocated to the recycler by the government under the cap-and-trade mechanism. Following the parameter specification in \cite{sun2021Optimal}, we set $G = 300$ (corresponding to 300 tons of CO$_2$ equivalent).
...
The impact of carbon trading price on profits under both game frameworks(as shown in Fig. 3) shows that as the carbon trading price increases, the profits of both participants decline, reflecting the additional carbon cost burden imposed on the recycler. However, the biform game demonstrates a stronger resilience to carbon price fluctuations compared to the non-cooperative baseline. Through the cost-sharing arrangement, the manufacturer shares part of the technology upgrade costs, enabling the recycler to achieve a higher conversion rate. The higher conversion rate generates greater marginal revenue, which acts as a buffer against rising carbon costs. Consequently, under the biform game framework, the optimal profits of the concrete manufacture and the recycler both maintain higher levels across the entire price range, validating the effectiveness of the coopetition strategy in mitigating environmental policy risks. This finding aligns with \citep{bai2022Distributionally} who demonstrated that cap-and-trade mechanisms alter firms' investment incentives by shifting the risk-return profile of technology upgrades. Extending this insight, \citep{zheng2024Optimal} further showed that biform game coordination under hybrid carbon regulations enables supply chain members to share carbon compliance costs, thereby enhancing system resilience against price volatility.

The impact of competition intensity on profits(as shown in Fig. 4) shows that as competition intensifies, both firms experience declining profits in both game frameworks. This pattern reflects the classic "prisoner's dilemma" in price competition: intensified competition compresses profit margins and forces firms to reduce collection efforts. Notably, the biform game consistently outperforms the non-cooperative baseline across all competition levels. The cooperative mechanism effectively alleviates destructive competition by aligning incentives: the manufacturer benefits from the recycler's technology improvements and thus has less incentive to engage in aggressive price cutting. The Shapley value allocation ensures that the cooperative surplus is fairly distributed, creating a win-win outcome that sustains the partnership even under fierce market competition. 
This structural transformation from zero-sum competition to sustainable value creation aligns with Bulmus et al. (2014) who identified the prisoner's dilemma in remanufacturing markets, and extends Luo et al. (2016) who demonstrated that coopetition transforms destructive rivalry into sustainable partnerships.

The impact of the cost coefficient on profits(as shown in Fig. 5) reveals that as $c$ increases, profits decline in both frameworks. The non-cooperative baseline is more sensitive to the cost coefficient because the recycler bears the full investment burden. In contrast, the biform game's cost-sharing mechanism, distributes the financial pressure, making profits less vulnerable to cost shocks. This finding highlights the importance of cooperative investment in promoting technology upgrading: under high investment cost environments, firms should prioritize strategic partnerships over independent R\&D to share risks and capture synergies. 
As highlighted in prior studies, cooperative coalitions can render capacity expansions and technological upgrades economically viable for specialized recyclers who might otherwise lack the necessary capital (Lu et al., 2014; Liu et al., 2019).
...
This subsection analyzes the heterogeneous impacts of three key parameters in the cap-and-trade mechanism: carbon trading price ($p_c$), carbon emission coefficient ($e$), and carbon quota ($G$). Under the cap-and-trade framework, enterprises must purchase carbon allowances when their emissions exceed the free quota $G$. The carbon cost is calculated as $p_c \cdot max(ecdot (alpha p_R - beta p_M) - G, 0)$, where a higher $p_c$ or $e$ increases compliance costs.

Fig. 8 illustrates the impact of carbon trading price ($p_c$) on equilibrium outcomes. As $p_c$ increases from 0 to 30, both participants experience declining profits, with the recycler suffering a more pronounced decline. This pattern reflects the carbon cost burden being primarily borne by the recycler under the delegated treatment model. When $p_c$ is low (below 10), both firms maintain positive profits, suggesting that moderate carbon pricing policies do not fundamentally undermine the viability of waste concrete recycling. However, as $p_c$ exceeds 20, the recycler's profit turns negative, indicating that high carbon prices may drive specialized processors out of the market. This finding aligns with policy research demonstrating that carbon pricing volatility imposes significant operational risks on recycling enterprises \cite{zheng2024New}.

Fig. 9 illustrates the impact of carbon emission coefficient ($e$) on equilibrium outcomes. As $e$ increases, indicating higher carbon intensity per unit of collected waste, the carbon cost escalates proportionally. The profit trajectories mirror those observed under rising $p_c$: both participants experience profit erosion, with the recycler again bearing a disproportionate share of the carbon burden. Interestingly, the collection quantities and conversion rates remain relatively stable, suggesting that firms absorb carbon costs through margin compression rather than reducing operational scale.

Fig. 10 illustrates the impact of carbon quota ($G$) on the recycler's profit. As $G$ increases, the free carbon allowance expands, reducing the carbon cost liability. Unlike $p_c$ and $e$, which negatively affect profits, increasing $G$ improves the recycler's economic performance. This demonstrates the critical role of free allocation in maintaining recycling profitability: with $G=0$, the recycler earns approximately 20,000, which increases to over 23,000 when $G=300$. This finding validates the policy design principle that adequate free allocation can offset carbon compliance costs and sustain recycling activity.

Overall, these results demonstrate that cap-and-trade mechanisms have heterogeneous effects depending on parameter settings. Policymakers should carefully calibrate $p_c$, $e$, and $G$ to balance environmental objectives with economic viability of the recycling sector.
...
Fig. 6 illustrates the impact of the price sensitivity coefficient on equilibrium outcomes. As the price sensitivity increases, waste generators become more responsive to changes in collection prices. The manufacturer's collection price exhibits a monotonic upward trend, whereas the recycler's collection price experiences a slight initial increase followed by a steady decline. The manufacturer consistently maintains a higher collection price compared to the recycler. This divergence stems from the inherent resource asymmetry between the two entities. The manufacturer capitalizes on its reverse logistics cost advantage to stimulate supply by raising prices. Conversely, the recycler, constrained by higher dedicated transportation costs and carbon emission liabilities under the cap-and-trade mechanism, rationally scales back its pricing strategy to control operational risks in the front-end collection market. This pattern of divergent pricing reflects Bulmus et al.'s observation that channel advantages in collection markets arise from differential cost structures---firms with lower logistics costs can afford to offer higher procurement prices to secure supply (Bulmus et al., 2014). Conversely, the recycler's cautious pricing reflects an essential risk-mitigation strategy under carbon and logistical constraints, echoing findings that structural heterogeneity fundamentally limits a participant's competitive pricing capacity\cite{he2020Investigation}.

Concurrently, the collection quantities for both participants and the total system collection expand significantly with an increase in $\alpha$. The manufacturer absorbs the majority of the market increment due to its sustained pricing advantage. The recycler's collection quantity continues to grow despite its reduced collection price, which is primarily driven by the overall expansion of the market scale activated by the high price sensitivity.

In the cooperative stage, the system conversion rate rises gradually, while the proportion of investment cost borne by the recycler exhibits a distinct monotonic decrease. As the total volume of collected waste concrete expands, the marginal benefit of improving the recycled concrete aggregate (RCA) quality increases. To ensure sufficient processing capability and higher RCA value, the manufacturer utilizes the surplus generated from its expanded collection market to bear a progressively larger share of the technology research and equipment upgrade costs. This dynamic demonstrates how the cooperative investment mechanism addresses the funding constraints of the specialized processor. As market scale expands, the amortized unit cost of collaborative R\&D drops, thereby catalyzing technological upgrades \cite{wu2019Offsite}. Ultimately, the recycler's capacity to innovate is not strictly bound by its own capital, but rather contingent upon the volume-driven scale economies unlocked by the alliance \cite{liu2019Expand}.

The economic outcomes indicate that both the manufacturer's profit and the recycler's profit increase, reflecting a mutual improvement in financial performance. Notably, the recycler maintains a higher absolute profit level and a steeper growth trajectory compared to the manufacturer. Within the delegated treatment framework, the recycler processes the extensive volume collected bythe manufacturer, generating stable transfer revenue. Furthermore, by shifting a significant portion ofthe capital expenditure tothe manufacturer throughthe cost-sharing agreement, the recycler effectively leverages its specialized processing capacity to capture a larger portion ofthe cooperative surplus. This profit distribution pattern aligns with Lu et al. (2014) who demonstrated that Shapley value allocation fairly credits each partner's marginal contribution to coalition gains, thereby sustaining cooperative incentives.

\noindent\textbf{(2) Impact of government subsidy ($s$) on recycling strategies.}
\label{sec:s_subsidy_impact}

Fig. 7 illustrates how the injection of a per-unit government subsidy fundamentally reshapes the equilibrium decisions of both participants. As depicted in Fig. 7(a) and Fig. 7(b), both collection prices and the resulting collection quantities exhibit a pronounced positive correlation with the subsidy level. By directly expanding the profit margin of the supply chain, the government subsidy empowers both the manufacturer and the recycler to translate this policy dividend into more aggressive front-end procurement strategies. The manufacturer strategically leverages its persistent reverse logistics advantage to maintain a higher collection price, thereby securing a dominant market share. The synchronized price escalation drives a substantial expansion in the total system collection volume. Rather than merely inflating individual profits, this mechanism illustrates how targeted financial interventions effectively shift the fundamental economic calculus of waste procurement, drawing resources into formal recycling channels and unlocking system-wide win-win scenarios \cite{yuan2023Differentiated}(Jia et al., 2017; Yuan et al., 2023).  

Fig. 7(c) illustrates the dynamics of the cooperative technology investment. The system conversion rate increases steadily with the government subsidy, while the recycler’s cost-sharing ratio rises sharply at lower subsidy levels before gradually stabilizing. In a low-subsidy environment, the recycler faces high downside risks for capital-intensive equipment upgrades and relies heavily on the manufacturer’s financial support. As the subsidy increases, the guaranteed per-unit revenue effectively mitigates these investment risks. Consequently, the recycler’s willingness to invest increases, leading it to assume a greater proportion of the technological costs. This indicates that government subsidies not only stimulate front-end collection but also serve as a catalyst for back-end capability upgrades by altering the risk-return profile of the specialized processor. This observation aligns with Jia et al. (2017) who demonstrated through system dynamics that government subsidies substantially improve recycling rates by altering the risk-return calculus of capital-intensive upgrades.

The profit trajectories in Fig. 7(d) indicate that both participants experience substantial financial growth, validating the effectiveness of the subsidy policy in promoting industry development. The recycler's profit accelerates faster and remains consistently higher than the manufacturer's profit. Within the delegated treatment model, the subsidy amplifies the volume of waste concrete transferred from the manufacturer to the recycler. The recycler processes this expanded volume, thereby maximizing its capacity utilization and economies of scale. Through the cooperative bargaining mechanism, the recycler leverages its indispensable processing capability to capture a premium from the subsidy-induced market expansion.

\noindent\textbf{(3) Impact of potential recycled value ($\theta$) on recycling strategies.}

Fig. 8 delineates the systemic responses to variations in the potential recycled value, which signifies the maximum market ceiling of high-quality recycled concrete aggregate (RCA). As depicted in Fig. 8(a) and 8(b), both collection prices and procured quantities trace a convex upward trajectory as $\theta$ appreciates. An elevated value expands the overarching profit frontier of the reverse supply chain. To aggressively capture this expanded margin, both participants escalate their procurement pricing to siphon more waste resources from the market. While the manufacturer relies on its inherent reverse logistics advantage to sustain a consistently higher baseline collection price, the recycler exhibits a remarkably steeper pricing growth curve at higher $\theta$ tiers. As the direct synthesizer of the end-product, the recycler possesses a heightened sensitivity to downstream value appreciation. Consequently, when the market outlook is sufficiently lucrative, the recycler structurally pivots toward an aggressive front-end procurement strategy to maximize the feedstock for its processing engine. 

This aggressive front-end behavior is intrinsically coupled with back-end capability upgrades, as illustrated in Fig. 8(c). Both the overarching system conversion rate and the recycler's internal cost-sharing ratio surge significantly in tandem with $\theta$. The surging value amplifies the marginal return on R\&D and equipment investments. Galvanized by this potent economic stimulus, the recycler becomes increasingly incentivized to shoulder a dominant proportion of the upgrade costs. This reveals that an appreciation in the intrinsic end-value of recycled materials transforms technological R\&D from a capital-heavy risk into a high-yield strategic asset. By intensifying cooperative investments to push the technological frontier, specialized processors can decisively intercept a larger fraction of the newly created market value, thereby shifting the industry's growth paradigm from volume-driven accumulation to value-driven extraction (Lu et al., 2014; Wu et al., 2019).

Regarding the economic performance shown in Fig. 8(d), both participants experience profit growth as $\theta$ increases. The recycler's profit is substantially higher than the manufacturer's profit and grows at a much faster rate. In environments with low potential value, the manufacturer's reverse logistics advantage plays a primary role in securing baseline returns. Conversely, as the potential value of the recycled material scales up, the recycler's specialized processing capability becomes the primary driver of value creation. The profit allocation mechanism in the cooperative stage reflects this fundamental shift in value drivers. Because the recycler is directly responsible for realizing the high potential value of the aggregate through processing, the Shapley value allocation enables it to capture a disproportionately larger share of the expanded market surplus.


\noindent\textbf{(4) Impact of outsourcing fee ($w$) and operational cost ($m$) on recycling strategies.}

Fig. 9 and Fig. 10 map the differential transmission mechanisms of the internal outsourcing fee and the external operational cost. Rather than propagating uniformly throughout the reverse supply chain, these parameters trigger asymmetric responses based on the channel structure and each entity's distinct bargaining position. The observed dynamics provide concrete evidence that heterogeneous cost configurations dictate channel power dynamics and system viability across different actors \cite{he2020Investigation}.  

Fig. 10 isolates the impact of the recycler's operational cost. As the operational cost increases, the recycler experiences a direct contraction in its processing margin. The recycler subsequently lowers its front-end collection price, leading to a severe decline in its procurement quantity. In contrast, the manufacturer's collection metrics and baseline profit remain largely insulated from this turbulence. By outsourcing the physical processing, the manufacturer structurally shields itself from back-end operational volatility. This decoupling effect confirms that specialized downstream processors act as the primary shock absorbers for exogenous cost fluctuations within vertical recycling partnerships, while upstream suppliers sustain stable margins via contractual arrangements \cite{chen2025Exploring}.  

Fig. 9 presents the systemic effects of manipulating the internal transfer price represented by the outsourcing fee. An increase in the outsourcing fee directly inflates the manufacturer's reverse procurement cost. Reacting to this margin squeeze, the manufacturer scales back its front-end collection price, inducing a steep downward trend in its collection volume. Because the total scale of the ecosystem relies heavily on the manufacturer's reverse logistics network, this upstream contraction cascades downstream and depresses the recycler's collection metrics.  

The profit dynamics mapped in Fig. 9(b) reveal a monotonic decline for both the manufacturer and the recycler as $w$ increases. While the higher outsourcing fee improves the recycler's per-unit processing margin, it simultaneously restricts the upstream collection volume upon which the recycler's capacity utilization heavily depends. The negative volume effect ultimately outweighs the positive price effect. Excessive internal transfer pricing therefore acts as a frictional force that dampens the economic performance of both participants. This mechanism demonstrates that when volume-dependent scale effects dominate unit-level margins, misaligned transfer pricing creates coordination friction and causes profit erosion across the entire value chain \cite{su2024Stakeholder}.  

\noindent\textbf{(5) Impact of transportation cost differential ($\mu_R - \mu_M$) on recycling strategies.}

Fig. 11 delineates the effect of the transportation cost differential on the equilibrium outcomes. This metric captures the magnitude of the manufacturer's reverse logistics advantage over the recycler's dedicated transportation expenses. As the logistics cost gap widens, the recycler is forced to lower its front-end procurement pricing to maintain operational viability, which steadily reduces its collection volume. Concurrently, the manufacturer's collection price and quantity remain highly stable, shielding its front-end strategy from the recycler's specific logistical disadvantages. The resulting contraction in the total system collection quantity mechanistically demonstrates how physical cost asymmetries reshape reverse channel structures by heavily penalizing participants lacking established backhaul networks \cite{wang2026Integration}.  

The negative impact of this logistical friction extends into the cooperative investment stage. The recycler's cost-sharing ratio decreases monotonically alongside a steady decline in the system conversion rate. Escalating dedicated transportation costs directly erode the recycler's financial reserves and subsequently diminish its capacity to co-fund equipment upgrades. Furthermore, the continuous contraction in the total collection volume intrinsically restricts the achievable economies of scale. A shrunken resource pool fails to provide the economic justification required for high-level processing capability. This volume-investment linkage provides empirical evidence that capital-intensive technological upgrades are strictly contingent upon sustaining sufficient collection throughput to amortize fixed costs (Lu et al., 2014).  

The economic outcomes plotted in Fig. 11(d) reveal that the external logistics friction is  absorbed by the recycler. The recycler's profit drops sharply as the cost differential expands, whereas the manufacturer's profit maintains relative stability. This asymmetric profit erosion shrinks the total cooperative surplus generated by the supply chain. Excessive disparities in physical logistics capabilities restrict not only individual financial performance but also the technological trajectory of the entire waste concrete recycling system.  
