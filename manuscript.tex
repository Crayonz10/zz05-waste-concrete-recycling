...
\subfloat[$p_c$ (carbon trading price)]{\includegraphics[width=0.45\textwidth]{fig1_profit_vs_pc.pdf}\label{fig:profit_vs_pc}}
\hfil
\subfloat[$\beta$]{\includegraphics[width=0.45\textwidth]{fig2_profit_vs_beta.pdf}\label{fig:profit_vs_beta}}
\vfil
\subfloat[$\ln(c)$]{\includegraphics[width=0.45\textwidth]{fig3_profit_vs_c.pdf}\label{fig:profit_vs_c}}
