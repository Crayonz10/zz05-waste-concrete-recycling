...
\begin{equation}
p_M^{N*} = \frac{
\displaystyle 4c^2 \left[ 2\alpha^2(s - w - \mu_M) + \alpha\beta(s - m - \mu_R) - \beta^2(w - m) \right]
...
\begin{equation}
p_R^{N*} = \frac{
\displaystyle 4c^2\alpha \left[ 2\alpha(s - m - \mu_R) + \beta(s - 3w + 2m - \mu_M) \right]
...
\begin{equation}
V_{p_M,p_R}(\{R\}) = \max_{k \in [0,1]} \min_{n \in [0,1]} \{\Pi_R\} = \max_{k \in [0,1]} \min_{n \in [0,1]} \{(\theta k + s - p_R - m - \mu_R)(\alpha p_R - \beta p_M) + (w - m)(\alpha p_M - \beta p_R) - n\frac{ck^2}{2} - p_c[e(\alpha-\beta)(p_M+p_R)-G]\}
\end{equation}
...
\begin{equation}
V_{p_M,p_R}(\{R\}) = \max_{k \in [0,1]} \{(\theta k + s - p_R - m - \mu_R)(\alpha p_R - \beta p_M) + (w - m)(\alpha p_M - \beta p_R) - \frac{ck^2}{2} - p_c[e(\alpha-\beta)(p_M+p_R)-G]\}
\end{equation}
...
\begin{equation}
V_{p_M,p_R}(\{R\}) = \left(s - p_R - m - \mu_R\right)(\alpha p_R - \beta p_M) + (w - m)(\alpha p_M - \beta p_R) + \frac{\theta^2(\alpha p_R - \beta p_M)^2}{2c} - p_c[e(\alpha-\beta)(p_M+p_R)-G]
\end{equation}
...
\begin{equation}
V_{p_M,p_R}(\{M,R\}) = \max_{k \in [0,1]} \{(\theta k + s - p_M - m - \mu_M)(\alpha p_M - \beta p_R) + (\theta k + s - p_R - m - \mu_R)(\alpha p_R - \beta p_M) - \frac{ck^2}{2} - p_c[e(\alpha-\beta)(p_M+p_R)-G]\}
\end{equation}
Taking the first derivative of the above equation with respect to $k$ and setting it to zero, we obtain:
\begin{equation}
...
Substituting $k^*$ into the characteristic function, we obtain:
\begin{equation}
V_{p_M,p_R}(\{M,R\}) = (s - p_M - m - \mu_M)(\alpha p_M - \beta p_R) + (s - p_R - m - \mu_R)(\alpha p_R - \beta p_M) + \frac{\theta^2(\alpha - \beta)^2(p_M + p_R)^2}{2c} - p_c[e(\alpha-\beta)(p_M+p_R)-G]
\end{equation}
